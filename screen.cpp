...
static int cury, curx; //obecne polozenie
...
void getscreenanchor(int &y, int &x)
{
  getbegyx(stdscr, y, x);
  /*
  The getbegyx() macro stores the absolute screen 
  coordinates of the specified window's origin in y and x. 
  */
}
